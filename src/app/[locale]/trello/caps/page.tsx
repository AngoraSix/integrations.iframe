...
const ROLES_ACTIVITIES_MAPPNIGS = [
    {
        ...
        activities: [{
            label: 'Escrito - Inglés -> Español',
            hourlyRate: 4000,
            hourlyCaps: 0.5
        },
        {
            label: 'Video - Español -> Inglés',
            hourlyRate: 7000,
            hourlyCaps: 0.7
        },
        {
    ...
    },
    {
        ...
        activities: [
            {
                label: 'Escrito - Español -> Portugués',
                hourlyRate: 5000,
                hourlyCaps: 1.1
            },
            {
                label: 'Video - Español -> Portugués',
                hourlyRate: 8000,
                hourlyCaps: 1.3
            },
            {
                label: 'Escrito - Portugués -> Español',
                hourlyRate: 5500,
                hourlyCaps: 1.6
            },
            {
                label: 'Video - Portugués -> Español',
                hourlyRate: 9000,
                hourlyCaps: 0.9
            }]
    },
...
const INITIAL_STATE = {
    selectedType: TASK_TYPES.CONTINUOUS_ACTIVITY.key,
